...
describe('cryptography', () => {
    test('test getDerivedPrivateKey', async () => {
        ...
        expect(
            (await wallet.getNewAddress({ privateKey: pri })).address
        ).toEqual(
            '0xc3aea2e9e0216a21527ce9dea42b4b0c09973720042220ab1dfde85f5c277953'
        );
        ...
        expect(
            ...
            '0xdaef02c4508480c020bde62be4520de33eeb57f5c3a8f19d2f1877027b91c82e'
        );
        ...
        expect(
            ...
            '0x0e103f2957391fab20351b7cc50240b05fe4480d7a88522ba361a78f408b4900'
        );
        ...
        expect(
            ...
            '0xfaacd3baa119b65d90a6b971e3ef4df7d105d17db9871dea461b2259d0f4cd21'
        );
        ...
        expect(
            ...
            '0xc4468c076dddcff4777d60ea9b48193e8768aa5c502aa63c4a4f39e626d691e8'
        );
        ...
        expect(
            ...
            '0x89afb35134bb3e518c68e0e1b2c1426d9a67f9c166242164e4d0d6f02929dab7'
        );
        ...
        expect(
            ...
            '0xc64c33c1db7ca12a0c577dcfc1b20eaa3c36df7581024cab910b3bea26c62e0b'
        );
        ...
        expect(
            ...
            '0x2ece1e49991b517f493febed80bbc7b7b092bfb267181aba1a628914dcffeb27'
        );
        ...
        expect(
            ...
            '0x5c7761d852420785b3cb5a64f1e205b6cb6d7cd5011adf7bc71b39b0b22883e2'
        );
        ...
        expect(
            ...
            '0x63790f2e0c670ccd4ea83a228f316cfaa5f9d619c943630bcc1793ab5a3e3ccc'
        );
        ...
        expect(
            ...
            '0x559f2882e18007401713c26814d3457114f1b3d91ab88ce97bf9ab6ea751c136'
        );
    });
    ...
    test('decoder or encoder SuiPrivateKey exception', async () => {
        ...
        k =
            '0x31342f041c5b54358074b4579231c8a300be65e687dff020bc7779598b42897axx';
    ...
    test('Ed25519Keypair.fromSecretKey - invalid length errors', () => {
        ...
        invalidLengths.forEach((length) => {
            ...
            expect(() => {
                ...
                `Wrong secretKey size. Expected 64 bytes, got ${length}.`
            );
        });
    });

...
describe('rune test', () => {
    ...
    test('segwit_taproot transfer rune', async () => {
        ...
        console.info(tx);
        const partial =
            /^[0-9a-fA-F]{260}00000000$/;
    ...
    describe('RuneWallet address validation', () => {
        let runeWallet: RuneWallet;
        const validPrivateKey =
            'KwTqEP5swztao5UdMWpxaAGtvmvQFjYGe1UDyrsZxjkLX9KVpN36';

        beforeEach(() => {
            runeWallet = new RuneWallet();
        });

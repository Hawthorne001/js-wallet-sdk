...
describe('crypto', () => {
    test('', async () => {
        expect(isHexStr('0x')).toEqual(true);
        expect(isHexStr('0x1')).toEqual(true);
        expect(isHexStr('0x12')).toEqual(true);
        expect(isHexStr('0x123456')).toEqual(true);
        expect(isHexStr('0x123456abcdef')).toEqual(true);
        expect(isHexStr('0x123456abcdefg')).toEqual(false);
        expect(
            isHexStr(
                '70736274ff01003d00000000012eb1ba16cbc7659ece4a151926de839f94e3e988c73ae6290af9d668f3b61061000000000000000000010000000000000000016a000000000001011f000000000000000016001480cd4b68ad2abace26a975b27b4689f91cd2c5f9010304010000000000'
            )
        ).toEqual(true);
    });
    ...
    test('getDerivedPrivateKey', async () => {
        ...
        let param = {
            mnemonic:
                'aerobic ocean arrow crew oyster oval proof club curious any hurt filter',
            hdPath: "m/44'/195'/0'/0/0",
        };
        let privateKey = await wallet.getDerivedPrivateKey(param);
        expect(privateKey).toEqual(
            '0xd4929dd3ec826d1d60e3b89f8f7c15f6046eb29b6a43a827197ede0b3bc74371'
        );
    });

    test('magicHash', async () => {
        let wallet = new SimpleWallet();
        let data = buildCommonSignMsg(
            '0x067aec3603bdca82e52a172ec69b2505a979f1d935a59409bacae5c7f268fc26',
            '123456789'
        );
        let param: SignCommonMsgParams = {
            privateKey:
                'aa2b47a2d76ddce0a9d2d11d03baa1d60c90aa97e0e7064287c2268e85637e80',
        ...
        if (true) {
            ...
            let publicKey =
                '067aec3603bdca82e52a172ec69b2505a979f1d935a59409bacae5c7f268fc26';
        ...
        // This test case is not right because the private key should be convert to 32 bytes length.
        // AdaWallet.signCommonMsg implements the right logic.
        // if (true) {
        //   //ada
        ...
        //     '';
        //   let publicKey =
        //     'f78d9bc8ca867c04f75fd86f2457c1ba35ce6b25e7cbc90356eea4b1503e2f537d3d86598bc62e0481f803603bc7f33cbddb1f185417e9386fce43d871c270b0';
        //   let addr =
        //     'addr1q95y9uu3ekfwmlu3mthnjeuptu95th8m0qzqw2kexej6xgpttfhlqgwy5vavd7ggzneerhd80456j736e085zcys9y9q5frsx7';
        //   wallet.mockData(addr, publicKey);
        //   param.message = { walletId: '123456789' };
        //   param.signType = SignType.ED25519;
        //   let sig = await wallet.signCommonMsg(param);
        ...
        if (true) {
            //wax
            param.privateKey =
                'e0c98a7a7506c7790ea2fd62a7df5f5e0be419d0787b29b00dee3131b9f985a9';
            let publicKey =
        ...
        if (true) {
            //eos
            param.privateKey =
                '579aa3f585cce7d0ba58e37a03be7b7eb7415d2bc3d92dfe9a23a5df0c7a48cc';
            let publicKey =
        ...
        if (true) {
            ...
            param.privateKey =
                '0743bf0e3864122edff9f143006f0a0d61b16df3f676c8070dac1d0f42d78353';
            let publicKey =
                '04052b16e71e4413f24f8504c3b188b7edebf97b424582877e4993ef9b23d0f0452c8b0c821e01cb6d1f57f882f748fef7146f06c7c96e0d03ec73cf97bf01959f';
        ...
        if (true) {
            ...
            param.privateKey =
                'ebc42dae1245fad403bd18f59f7283dc18724d2fc843b61e01224b9789057347';
            let publicKey =
                'ed25519:1eZPzUUUAtHcrQzCtbsA1feL82pVgHAwkXLEjt5U3T1';
            let addr =
        ...
        if (true) {
            //nostrassets
            param.privateKey =
                'bb1c93508b962c7efb0a340848538b2c5f7ba6c44e55f52389aa132a2fd3521a';
            let publicKey =
    ...
    test('magicHash2', async () => {
        ...
        if (true) {
            ...
            let publicKey =
                'fd5fd86d7d7b8355492b1517a96a2fbb17e1a374b80a21559bdfee0dfbaa0b32';
        ...
        if (true) {
            ...
            let publicKey =
                '040f7d0377754e1865740fb42460ac55fcc8a4d6aac611b697f88cfc2091f318d8a0385810e607f0704388628d7275bd16c09bcccb71dd2048e778a9ac13fbb41c';
        ...
        if (true) {
            ...
            let addr =
                '1e7fa5fd46bdf8ec1291ca52084bdbeeabde6b3bab3a5d9e6cf83d78061de619';
            wallet.mockData(addr, publicKey);
            param.message = { walletId: '123456789' };
            param.signType = SignType.ED25519;
            let sig = await wallet.signCommonMsg(param);
        ...
        if (true) {
            ...
            let publicKey =
                '04fde2eacd2fcbdeeeba4cd53af8e3aea60a5bddba2c129de4b325eede06ca7cea2d4a60079ccddc7e110c2cdd665fa302789793d9fc40054812e210cd5bab5367';
...
describe('wallet utility functions', () => {
    describe('secp256k1SignTest', () => {
        it('should correctly test secp256k1 signature', () => {
            const { secp256k1SignTest } = require('../src/wallet');
            const privateKey = Buffer.from(
                '1234567890123456789012345678901234567890123456789012345678901234',
                'hex'
            );

            const result = secp256k1SignTest(privateKey);
            expect(result).toBe(true);
        });
    });

    describe('makeSignature', () => {
        it('should correctly build signature', () => {
            const { makeSignature } = require('../src/wallet');
            const v = 27;
            const r = Buffer.from(
                '1234567890123456789012345678901234567890123456789012345678901234',
                'hex'
            ...
            expect(result).toHaveLength(130); // 0x + 64 + 64
            expect(result.startsWith('1b')).toBe(true); // v=27 in hexadecimal
        });
    });

    describe('intToHex', () => {
        it('should convert number to hexadecimal', () => {
            const { intToHex } = require('../src/wallet');

            expect(intToHex(0)).toBe('0x0');
            expect(intToHex(255)).toBe('0xff');
            expect(intToHex(16)).toBe('0x10');
            expect(intToHex(27)).toBe('0x1b');
        });
    });

    describe('toUnsigned', () => {
        it('should convert BN to unsigned Buffer', () => {
            const { toUnsigned } = require('../src/wallet');
            const { BN } = require('../src');

            const bn = new BN('12345678901234567890');
            const result = toUnsigned(bn);
    ...
    describe('padWithZeroes', () => {
        it('should correctly pad hexadecimal string', () => {
            const { padWithZeroes } = require('../src/wallet');

            expect(padWithZeroes('abc', 6)).toBe('000abc');
            expect(padWithZeroes('123456', 8)).toBe('00123456');
            expect(padWithZeroes('', 4)).toBe('0000');
        });

        it('should validate hexadecimal string format', () => {
            const { padWithZeroes } = require('../src/wallet');

            expect(() => padWithZeroes('invalid', 6)).toThrow(
                'Expected an unprefixed hex string'
            );
            expect(() => padWithZeroes('0xabc', 6)).toThrow(
                'Expected an unprefixed hex string'
            );
        });
        ...
        it('should validate target length', () => {
            ...
            expect(() => padWithZeroes('abc', -1)).toThrow(
                'Expected a non-negative integer target length'
            );
        });
    });

    describe('fromSigned', () => {
        it('should create signed BN from Buffer', () => {
            const { fromSigned } = require('../src/wallet');
            const { BN } = require('../src');
            ...
            const result = fromSigned(buffer);
    ...
    describe('ecdsaSign', () => {
        it('should correctly perform ECDSA signature', () => {
            const { ecdsaSign } = require('../src/wallet');
            ...
            const result = ecdsaSign(msgHash, privateKey);

            expect(result).toHaveProperty('v');
            expect(result).toHaveProperty('r');
            expect(result).toHaveProperty('s');
            expect(result.r).toBeInstanceOf(Buffer);
            expect(result.s).toBeInstanceOf(Buffer);
            expect(typeof result.v).toBe('number');
        });

        it('should handle signature with chainId', () => {
            const { ecdsaSign } = require('../src/wallet');
            ...
            const result = ecdsaSign(msgHash, privateKey, chainId);

            expect(result.v).toBeGreaterThan(35); // chainId * 2 + 35 + recovery
        });

        it('should validate chainId safe integer', () => {
            const { ecdsaSign } = require('../src/wallet');
            ...
            const chainId = Number.MAX_SAFE_INTEGER + 1;

            expect(() => ecdsaSign(msgHash, privateKey, chainId)).toThrow(
...
describe('BaseWallet class', () => {
    ...
    describe('getRandomPrivateKey', () => {
        it('should generate valid private key', async () => {
    ...
    describe('getDerivedPrivateKey', () => {
        ...
        it('should handle invalid mnemonic', async () => {
            ...
            await expect(wallet.getDerivedPrivateKey(param)).rejects.toBe(
                'generate private key error'
            );
        });
    });

    describe('getDerivedPrivateKeyOld', () => {
        it('should derive private key using old method', async () => {
            const param = {
                mnemonic:
                    'test test test test test test test test test test test junk',
                hdPath: "m/44'/60'/0'/0/0",
            ...
            const result = await wallet.getDerivedPrivateKeyOld(param);
    ...
    describe('getDerivedPath', () => {
        it('should throw NotImplementedError', async () => {
            await expect(wallet.getDerivedPath({ index: 0 })).rejects.toBe(
    ...
    describe('validPrivateKey', () => {
        it('should throw NotImplementedError', async () => {
            await expect(
                wallet.validPrivateKey({ privateKey: '0x123' })
            ).rejects.toBe('no implementation method');
        });
    });
    ...
    describe('signMessage', () => {
        it('should throw NotImplementedError', async () => {
            await expect(
                wallet.signMessage({ privateKey: '0x123', data: 'test' })
            ).rejects.toBe('no implementation method');
        });
    });

    describe('signCommonMsg', () => {
        it('should sign with text message', async () => {
            const params = {
                privateKey:
                    '1234567890123456789012345678901234567890123456789012345678901234',
                signType: 1, // Secp256k1
                message: { text: 'Hello World' },
            };

            const result = await wallet.signCommonMsg(params);

            expect(result).toMatch(/^[a-f0-9]+$/);
        });

        it('should handle missing walletId', async () => {
            const params = {
                privateKey:
                    '1234567890123456789012345678901234567890123456789012345678901234',
                signType: 1,
            ...
            wallet.mockData('test-address', 'test-public-key');

            await expect(wallet.signCommonMsg(params)).rejects.toBe(
                'invalid walletId'
            );
        });

        it('should handle Sui chain special case', async () => {
            const params = {
                privateKey:
                    '1234567890123456789012345678901234567890123456789012345678901234',
                signType: 1,
            ...
            wallet.mockData('test-address', '0x1234567890abcdef');
        ...
        it('should handle different signature types', async () => {
            ...
            const result1 = await wallet.signCommonMsg(params1);
            ...
            const result2 = await wallet.signCommonMsg(params2);
            expect(result2).toMatch(/^[a-f0-9]+$/);

            // TezosSignType
            const params4 = {
                privateKey,
                signType: 5, // TezosSignType
                message: { walletId: '123' },
            };

            await expect(wallet.signCommonMsg(params4)).rejects.toBe(
                'not support'
            );
        });
    });

    describe('other abstract methods', () => {
        it('verifyMessage should throw NotImplementedError', async () => {
            await expect(
                wallet.verifyMessage({ signature: 'test', data: 'test' })
            ).rejects.toBe('no implementation method');
        });

        it('ecRecover should throw NotImplementedError', async () => {
            await expect(
                wallet.ecRecover({ message: 'test' }, 'test')
            ).rejects.toBe('no implementation method');
        });

        it('getAddressByPublicKey should throw NotImplementedError', async () => {
            await expect(
                wallet.getAddressByPublicKey({ publicKey: 'test' })
            ).rejects.toBe('no implementation method');
        });

        it('getMPCRawTransaction should throw NotImplementedError', async () => {
            await expect(
                wallet.getMPCRawTransaction({ data: 'test' })
            ).rejects.toBe('no implementation method');
        });

        it('getMPCTransaction should throw NotImplementedError', async () => {
            await expect(
                wallet.getMPCTransaction({ raw: 'test', sigs: 'test' })
            ).rejects.toBe('no implementation method');
        });

        it('getMPCRawMessage should throw NotImplementedError', async () => {
            await expect(
                wallet.getMPCRawMessage({ data: 'test' })
            ).rejects.toBe('no implementation method');
        });

        it('getMPCSignedMessage should throw NotImplementedError', async () => {
            await expect(
                wallet.getMPCSignedMessage({ hash: 'test', sigs: 'test' })
            ).rejects.toBe('no implementation method');
        });

        it('getHardWareRawTransaction should throw NotImplementedError', async () => {
            await expect(
        ...
        it('getHardWareSignedTransaction should throw NotImplementedError', async () => {
            await expect(
                wallet.getHardWareSignedTransaction({ raw: 'test' })
            ).rejects.toBe('no implementation method');
        });

        it('getHardWareMessageHash should throw NotImplementedError', async () => {
            await expect(
                wallet.getHardWareMessageHash({
                    privateKey: 'test',
                    data: 'test',
                })
            ).rejects.toBe('no implementation method');
        ...
        it('calcTxHash should throw NotImplementedError', async () => {
            await expect(wallet.calcTxHash({ raw: 'test' })).rejects.toBe(
                'no implementation method'
            );
        });

        it('getRawTransaction should throw NotImplementedError', async () => {
            await expect(
                wallet.getRawTransaction({ data: 'test' })
            ).rejects.toBe('no implementation method');
        });

        it('validSignedTransaction should throw NotImplementedError', async () => {
            await expect(
                wallet.validSignedTransaction({ tx: 'test' })
            ).rejects.toBe('no implementation method');
        });

        it('estimateFee should throw NotImplementedError', async () => {
            await expect(
                wallet.estimateFee({ privateKey: 'test', data: 'test' })
            ).rejects.toBe('no implementation method');
        });
    });
});

describe('SimpleWallet class', () => {
    let wallet: any;
    ...
    describe('mockData', () => {
        it('should set mock data', () => {
            ...
            wallet.mockData(mockAddress, mockPublicKey);

            expect(wallet.mockAddress).toBe(mockAddress);
            expect(wallet.mockPublicKey).toBe(mockPublicKey);
        });
    });
    ...
    describe('getNewAddress', () => {
        it('should return mock address', async () => {
            ...
            const result = await wallet.getNewAddress({ privateKey: 'test' });
    ...
    describe('signTransaction', () => {
        it('should throw not implemented error', () => {
            expect(() =>
                wallet.signTransaction({ privateKey: 'test', data: 'test' })

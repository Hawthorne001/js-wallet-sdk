...
describe('math module', () => {
        ...
        describe('arithmetic operations', () => {
            ...
            it('should throw error when subtracting larger number', () => {
                ...
                expect(() => a.minus(b)).toThrow(
                    'Difference must not be negative'
                );
            });
    ...
    describe('Uint32 class', () => {
        describe('constructor', () => {
            ...
            it('should throw error for negative number', () => {
                expect(() => new Uint32(-1)).toThrow(
                    'Input not in uint32 range: -1'
                );
            });
            ...
            it('should throw error for non-integer', () => {
                expect(() => new Uint32(123.45)).toThrow(
    ...
    describe('Int53 class', () => {
        describe('constructor', () => {
            ...
            it('should throw error for non-integer', () => {
                expect(() => new Int53(123.45)).toThrow(
                    'Input is not an integer'
                );
            });
        ...
        describe('fromString', () => {
            ...
            it('should throw error for invalid string format', () => {
                expect(() => Int53.fromString('123a')).toThrow(
                    'Invalid string format'
                );
    ...
    describe('Uint53 class', () => {
        ...
        describe('fromString', () => {
            ...
            it('should throw error for negative string', () => {
                expect(() => Uint53.fromString('-12345')).toThrow(
                    'Input is negative'
                );
            });
        });
    ...
    describe('Uint64 class', () => {
        ...
        describe('fromNumber', () => {
            ...
            it('should throw error for negative number', () => {
                expect(() => Uint64.fromNumber(-12345)).toThrow(
                    'Input is negative'
                );
            });
            ...
            it('should throw error for NaN', () => {
                expect(() => Uint64.fromNumber(NaN)).toThrow(
            ...
            it('should throw error for unsafe integer', () => {
                expect(() =>
                    Uint64.fromNumber(Number.MAX_SAFE_INTEGER + 1)
                ).toThrow('Input is not a safe integer');
            });
        });
        ...
        describe('fromBytes', () => {
            ...
            it('should throw error for invalid byte values', () => {
                expect(() =>
                    Uint64.fromBytes([1, 2, 3, 4, 5, 6, 7, 256])
                ).toThrow('Invalid value in byte. Found: 256');
            });
        });

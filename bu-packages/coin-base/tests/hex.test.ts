...
describe('validateHexString', () => {
    it('fromHex', () => {
        ...
        expect(fromHex('0x1234567')).toEqual(
            Buffer.from([0x01, 0x23, 0x45, 0x67])
        );
        ...
        expect(() => fromHex('0x12 34')).toThrow('invalid hex string');
        expect(() =>
            fromHex(`72f798f8b709902453d4bb55c65
61e9e04154a506765f2333dfb7e7834056d2`)
        ).toThrow('invalid hex string');
        expect(() =>
            fromHex(
                `72f798f8b709902453d4bb55c65\n61e9e04154a506765f2333dfb7e7834056d2`
            )
        ).toThrow('invalid hex string');
    });

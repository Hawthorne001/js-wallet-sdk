...
const res = await API.epochsLatestParameters();
console.log(res);
 */

export const blockfrostParams = {
    epoch: 550,
    min_fee_a: 44,
    min_fee_b: 155381,
    ...
    nonce: '1dc408ac6e6d230e2560a288943ede3b952585e2f1cfb0312afa9703cdb3f2ee',
    cost_models: {
        PlutusV1: {
...
export const getProtocolParams = (params: any): Cardano.ProtocolParameters => ({
    ...
    minCommitteeSize: 0,
    minFeeCoefficient: params.min_fee_a,
    minFeeConstant: params.min_fee_b,
    minPoolCost: Number(params.min_pool_cost),
    monetaryExpansion: params.rho.toString(),
    poolDeposit: Number(params.pool_deposit),
    poolInfluence: params.a0.toString(),
    poolRetirementEpochBound: params.e_max,

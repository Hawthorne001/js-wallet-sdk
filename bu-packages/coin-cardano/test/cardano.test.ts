...
import { base, InvalidPrivateKeyError } from '@okxweb3/coin-base';
...
describe('account', () => {
    test('derive key', async () => {
        let mnemonic =
            'bean mountain minute enemy state always weekend accuse flag wait island tortoise';
    ...
    test('addressFromPubKey', async () => {
        ...
        const addressData2 = await wallet.getNewAddress({
            privateKey: '0x' + privateKey,
        });
        expect(addressData2.publicKey).toEqual(publicKey);

        const addressData3 = await wallet.getNewAddress({
            privateKey: '0X' + privateKey,
        });
        expect(addressData3.publicKey).toEqual(publicKey);

        const addressData4 = await wallet.getNewAddress({
        ...
        expect(await addressFromPubKey('0x' + publicKey)).toEqual(
            expectedAddress
        );
        expect(await addressFromPubKey('0X' + publicKey)).toEqual(
            expectedAddress
        );
        expect(await addressFromPubKey('0X' + publicKey.toUpperCase())).toEqual(
            expectedAddress
        );
    });
    ...
    test('bech32 address to hex address', () => {
        const bech32Address =
            'addr1q8nrdx6sukqwatkv7x8y0csl0x2l0rek9cmc04n5z35anxphyemygs8dxvfe432u6xcrt89d968u478w6s0cu8x7thrsng2ztx';
        const expectedHexAddress =
            '01e6369b50e580eeaeccf18e47e21f7995f78f362e3787d6741469d9983726764440ed33139ac55cd1b0359cad2e8fcaf8eed41f8e1cde5dc7';
        expect(wallet.bech32AddressToHexAddress(bech32Address)).toEqual(
            expectedHexAddress
        );
    });
});
...
describe('transaction', () => {
            ...
            inputs: [
                {
                    ...
                    index: 0,
                    address:
                        'addr1q8yx6w98nxmg45mvumeh8f26f2wkj8ard0jufmwxwq8q7khxzx9jj2ueswgn9ln0npdu4jm0z8ewehsl40mqkspeg56s68fjud',
                    amount: '10000000', // 10 ADA input
                },
            ],
            address:
                'addr1q88vdk7j6h2d98u5e2hmxqh9sxdh0atx873yzhzhnrasekdt0l90f5x6mzhq8r9z2h776c8phzd2sy5p0ewkvvynf50qsxwezv',
    ...
    test('Change removed, insufficient for new fee', async () => {
        ...
        await expect(
            wallet.signTransaction({ data: testData, privateKey })
    ...
    test('Insufficient input ADA', async () => {
        ...
        await expect(
            AdaWallet.minFee({ data: testData, privateKey })
        ).rejects.toThrow('not enough input ada');
        await expect(
            wallet.signTransaction({ data: testData, privateKey })
        ).rejects.toMatch(/sign tx error/);
    });
    ...
    test('transfer', async () => {
        ...
        const ada = await AdaWallet.minAda(
            param.data.address,
            param.data.multiAsset
        );
    ...
    test('sign dapp tx', async () => {
        const txCbor =
            '';
        ...
        const witnessSet = await wallet.signTransaction({
            data: { type: 'rawTx', tx: txCbor },
            privateKey,
        });
        expect(witnessSet).toEqual(
            'a10081825820f78d9bc8ca867c04f75fd86f2457c1ba35ce6b25e7cbc90356eea4b1503e2f535840c4d51241d2d74950fc4b74dede4942d8a2ef553e5dff7d30086c63e341332c6185a5363f4380587a7f1b3d6fa49022579067f4acf97136fcc05db7bc17e5c905'
        );
    });
    ...
    test('getUtxos', async () => {
        ...
        const valueCbor =
            '821a00118f32a1581c29d222ce763455e3d7a09a665ce554f00ac89d2e99a1a83d267170c6a1434d494e1a00030d40';
        ...
        expect(sum).toEqual(
            '821a012684a4a1581c29d222ce763455e3d7a09a665ce554f00ac89d2e99a1a83d267170c6a1434d494e1a00995192'
        );
    });
    ...
    test('message', async () => {
        const address =
            'addr1q95y9uu3ekfwmlu3mthnjeuptu95th8m0qzqw2kexej6xgpttfhlqgwy5vavd7ggzneerhd80456j736e085zcys9y9q5frsx7';
        const hash =
            'd2b850c8c45abc5364b12da492ba718c6668c3d1d7dc8ef4ae6190581514cac7';
        const expected = {
            signature:
                '',
    ...
    test('signMessage should reject when privateKey is invalid', async () => {
        const address =
            'addr1q95y9uu3ekfwmlu3mthnjeuptu95th8m0qzqw2kexej6xgpttfhlqgwy5vavd7ggzneerhd80456j736e085zcys9y9q5frsx7';
        const hash =
            'd2b850c8c45abc5364b12da492ba718c6668c3d1d7dc8ef4ae6190581514cac7';
        const invalidPrivateKey = privateKey.slice(0, -2);
    ...
    describe('signTransaction recipient address validation', () => {
        ...
        test('should accept valid Cardano address', async () => {
        ...
        test('should reject invalid recipient addresses', async () => {
            const invalidAddresses = [
                ...
                { address: '0x1234567890abcdef', reason: 'Ethereum address' },
                {
                ...
                },
                {
                    ...
                    reason: 'Bitcoin bech32 address',
                },
                { address: 'addr1invalid', reason: 'Invalid Cardano address' },
                {
                    address:
                        'test1qyxdgpwcqsrfsfv7gs3el47ym205hxaxnnpvs550czrjr8gr7z40zns2zm4kdd5jgxhawpstcgnyt4zdwzn4e9g6qmksvhsufu',
                    reason: 'Wrong hrp prefix',
                },
        ...
        test('should accept valid change address', async () => {
            const validChangeAddress =
                'addr1q95y9uu3ekfwmlu3mthnjeuptu95th8m0qzqw2kexej6xgpttfhlqgwy5vavd7ggzneerhd80456j736e085zcys9y9q5frsx7';

...
module.exports = {
    ...
    moduleNameMapper: {
        '^@kaiachain/ethers-ext/src/v6$':
            '<rootDir>/node_modules/@kaiachain/ethers-ext/src/v6',
        '^@kaiachain/js-ext-core/util$':
            '<rootDir>/node_modules/@kaiachain/js-ext-core/util',
        '^@kaiachain/js-ext-core/ethers-v6$':
            '<rootDir>/node_modules/@kaiachain/js-ext-core/ethers-v6',
    },
};

...
describe('Common Tests', () => {
    describe('parseInputScriptDataParam', () => {
        ...
        function createSerializedArg(
            variant: ScriptTransactionArgumentVariants,
            value?: any
        ): string {
            ...
            switch (variant) {
                ...
                case ScriptTransactionArgumentVariants.U64:
                    serializer.serializeU64(
                        BigInt(value || 12345678901234567890n)
                    );
                    break;
                case ScriptTransactionArgumentVariants.U128:
                    serializer.serializeU128(
                        BigInt(value || 123456789012345678901234567890n)
                    );
                    break;
        ...
        test('parseInputScriptDataParam with U8 argument', () => {
            const param: InputScriptDataParam = {
                ...
                functionArguments: [
                    createSerializedArg(
                        ScriptTransactionArgumentVariants.U8,
                        42
                    ),
                ],
            };
        ...
        test('parseInputScriptDataParam with U16 argument', () => {
            const param: InputScriptDataParam = {
                ...
                functionArguments: [
                    createSerializedArg(
                        ScriptTransactionArgumentVariants.U16,
                        1000
                    ),
                ],
            };
        ...
        test('parseInputScriptDataParam with U32 argument', () => {
            const param: InputScriptDataParam = {
                ...
                functionArguments: [
                    createSerializedArg(
                        ScriptTransactionArgumentVariants.U32,
                        50000
                    ),
                ],
            };
        ...
        test('parseInputScriptDataParam with U64 argument', () => {
            const param: InputScriptDataParam = {
                ...
                functionArguments: [
                    createSerializedArg(
                        ScriptTransactionArgumentVariants.U64,
                        9876543210n
                    ),
                ],
            };
            ...
            expect((result.functionArguments[0] as U64).value).toBe(
                9876543210n
            );
        });
        ...
        test('parseInputScriptDataParam with U128 argument', () => {
            const param: InputScriptDataParam = {
                ...
                functionArguments: [
                    createSerializedArg(
                        ScriptTransactionArgumentVariants.U128,
            ...
            expect((result.functionArguments[0] as U128).value).toBe(
                98765432109876543210n
            );
        });
        ...
        test('parseInputScriptDataParam with U256 argument', () => {
            const param: InputScriptDataParam = {
                ...
                functionArguments: [
                    createSerializedArg(
                        ScriptTransactionArgumentVariants.U256,
                        98765432109876543210987654321098765n
                    ),
                ],
            };
            ...
            expect((result.functionArguments[0] as U256).value).toBe(
                98765432109876543210987654321098765n
            );
        });
        ...
        test('parseInputScriptDataParam with Bool argument (true)', () => {
            const param: InputScriptDataParam = {
                ...
                functionArguments: [
                    createSerializedArg(
                        ScriptTransactionArgumentVariants.Bool,
                        true
                    ),
                ],
            };
        ...
        test('parseInputScriptDataParam with Address argument', () => {
            const param: InputScriptDataParam = {
                ...
                functionArguments: [
                    createSerializedArg(
                        ScriptTransactionArgumentVariants.Address,
                        '0x42'
                    ),
                ],
            };
            ...
            expect(
                (result.functionArguments[0] as AccountAddress).toString()
            ).toBe(
        ...
        test('parseInputScriptDataParam with U8Vector argument', () => {
            ...
            const param: InputScriptDataParam = {
                ...
                functionArguments: [
                    createSerializedArg(
                        ScriptTransactionArgumentVariants.U8Vector,
                        testData
                    ),
                ],
            };
            ...
            expect(vector.values.map((v) => v.value)).toEqual([
                10, 20, 30, 40, 50,
            ]);
        });
        ...
        test('parseInputScriptDataParam with Serialized argument', () => {
            ...
            expect(Array.from(serialized.value)).toEqual([
                0xaa, 0xbb, 0xcc, 0xdd,
            ]);
        });
        ...
        test('parseInputScriptDataParam with multiple arguments of different types', () => {
            ...
            expect(
                (result.functionArguments[2] as AccountAddress).toString()
            ).toBe(
        ...
        test('parseInputScriptDataParam with invalid variant throws error', () => {
            ...
            expect(() => parseInputScriptDataParam(param)).toThrow(
                'Invalid Param'
            );
        });

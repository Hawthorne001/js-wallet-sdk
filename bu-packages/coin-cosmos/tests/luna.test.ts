...
describe('luna', () => {
        ...
        expect(
            (
                await wallet.validPrivateKey({
                    privateKey: '0X' + privateKey.toLowerCase(),
                })
            ).isValid
        ).toEqual(true);
    });
    ...
    test('sendToken', async () => {
        ...
        expect(v).toStrictEqual(
            ''
        );
    });
    ...
    test('sendIBCTransfer', async () => {
        ...
        const expected =
            '';
    ...
    test('sendMessage', async () => {
        ...
        const expected =
            'EmQKUApGCh8vY29zbW9zLmNyeXB0by5zZWNwMjU2azEuUHViS2V5EiMKIQP3ndcCmlkF5VeQYUKwxX7CH0dF8Sm4wFeuzPQuJ1C6bhIECgIIARgCEhAKCgoFdW9zbW8SATAQoI0GGkBcix83ia1Jyc0AHKJW5qRX5Q3tjy/4hanMgU03ojpq9wo16A+HvnnQIQk5VNaAgeyD984tOcWP2VJQEPpqXQsA';
        expect(v).toBe(expected);
    });
    ...
    test('osmosis-json', async () => {
        ...
        const prefix = 'osmo';
        const tt = await sendAminoMessage(
            privateKey,
            prefix,
            data,
            OsmosisAminoConverters,
        ...
        const expected =
            '';
...
describe('evmos', () => {
    ...
    test('sendToken', async () => {
        ...
        const expected =
            '';
        expect(v).toBe(expected);
    });
    ...
    test('sendIBCTransfer_1', async () => {
        ...
        const expected =
            '';
        expect(v).toBe(expected);
    });
});
...
describe('sei', () => {
    ...
    test('sendToken', async () => {
        ...
        expect(v).toStrictEqual(
            ''
        );
    });
    ...
    test('sendIBCTransfer', async () => {
        ...
        expect(v).toStrictEqual(
            ''
        );
    });
});
...
describe('injective', () => {
    ...
    test('sendToken', async () => {
        ...
        expect(v).toStrictEqual(
            ''
        );
    });
    ...
    test('sendIBCTransfer', async () => {
        ...
        const expected =
            '';
        expect(v).toBe(expected);
    });
    ...
    test('injective-getAddressByPublicKey', async () => {
        ...
        let c = await wallet.getAddressByPublicKey({
            publicKey:
                '038bffbf6a298c27e338b4c9ab670ac4b35678250b9bf4eebea9f56a327f56af7c',
            hrp: 'inj',
        });
    ...
    test('injective-signmessage', async () => {
        ...
        const expected =
            '/XuNUR7sZxUcNy49VdbFl/mrii3DhungqP2bTAtBryk9d54fJ5fx20Mdpps7kL1Ty54ezlzTtZTyH7DNv7xjzQ==';
        expect(v).toBe(expected);
    });
    ...
    test('injective-signmessage-2', async () => {
        ...
        const v = await wallet.signMessage({ privateKey, data });
        const expected =
            'BFiUnJlDqEpxfrOTTO0V3UUZjgRNV7RRcHrDfYREAcs2Tu0Jbdis6rlxgwHWZZ9HoCLJgf7wNNjOY/SCago94g==';
        expect(v).toBe(expected);
    });
});
...
describe('common_wallet', () => {
    test('getNewAddress', async () => {
        ...
        let privateHex =
            'd7c51e968395a42dccef5c250f083c526a711d97e3723fff2bc6e250223a7815';
        {
            ...
            expect(address.address).toEqual(
                'sei1gygujuyk00uxachg33x3eadtwq5cxqhs87arec'
            );
        }
        {
            ...
            expect(address.address).toEqual(
                'osmo1gygujuyk00uxachg33x3eadtwq5cxqhszfl9ft'
            );
        }
        {
            ...
            const address = await wallet.getNewAddress({
                privateKey:
                    '0x6a469518df93deadecef1c1ef668f2d168e1f80c3f3d1f985832b765d2a80916',
            });
            expect(address.address).toEqual(
                'evmos19w2knpdgz87cuqk83j4xw8zedz9dlauny80xfs'
            );
        }
        {
            ...
            expect(address.address).toEqual(
                'axelar1gygujuyk00uxachg33x3eadtwq5cxqhswu6a5c'
            );
        }
        {
            ...
            expect(address.address).toEqual(
                'cro1tmf35ysa2u5kuv0upv3xus8fc0h7nqlfaxzup0'
            );
        }
        {
            ...
            expect(address.address).toEqual(
                'iaa1gygujuyk00uxachg33x3eadtwq5cxqhslsvyag'
            );
        }
        {
            ...
            expect(address.address).toEqual(
                'juno1gygujuyk00uxachg33x3eadtwq5cxqhsuq0wc9'
            );
        }
        {
            ...
            const address = await wallet.getNewAddress({
                privateKey:
                    '0xe3c18b78724b9ae3b2ed54231192373ed030b677d224bd1fdc3a8b0313e7bb33',
            });
            expect(address.address).toEqual(
                'kava1xud79am45d55qkt8v00zf3raqeqcz4us3xp4vy'
            );
        }
        {
            ...
            expect(address.address).toEqual(
                'kujira1gygujuyk00uxachg33x3eadtwq5cxqhsm6wdjn'
            );
        }
        {
            ...
            const address = await wallet.getNewAddress({
                privateKey:
                    '0x61ab4f114f9918dc182558caac097381f6ca08007581d23d102004a05fa2021b',
            });
            expect(address.address).toEqual(
                'secret1zy6wlu8f0evmnjrek2me3ww5xfx07w7sc8k2ku'
            );
        }
        {
            ...
            expect(address.address).toEqual(
                'stars1gygujuyk00uxachg33x3eadtwq5cxqhs7wmg5g'
            );
        }
        {
            ...
            const address = await wallet.getNewAddress({
                privateKey:
                    '0xead09cd31b8680199e5281256a090183d87217698fc98c4c7fbbddcc3bb1818f',
            });
            expect(address.address).toEqual(
                'terra14psgu3ted0mxn3p353965geppt39r8aezfcp3c'
            );
        }
        {
            ...
            expect(address.address).toEqual(
                'dydx1gygujuyk00uxachg33x3eadtwq5cxqhsrtz3lw'
            );
        }
        {
            const wallet = new InjectiveWallet();
            ...
            expect(address.address).toEqual(
                'inj19w2knpdgz87cuqk83j4xw8zedz9dlaunv0fvpq'
            );
        }
        {
            ...
            expect(address.address).toEqual(
                'celestia1gygujuyk00uxachg33x3eadtwq5cxqhsmca995'
            );
        }
    });
    test('address', async () => {

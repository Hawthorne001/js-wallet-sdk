...
export function isTelescopeGeneratedCodec(
    type: GeneratedType
): type is TelescopeGeneratedCodec {
...
export function isTxBodyEncodeObject(
    ...
    return (
        (encodeObject as TxBodyEncodeObject).typeUrl ===
...
export function registerExtraTypes(
    types?: ReadonlyArray<[string, GeneratedType]>
) {
    if (types) {
        types.forEach((v) => {

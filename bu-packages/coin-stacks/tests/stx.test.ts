...
describe('StxWallet comprehensive tests', () => {
    ...
    describe('verifyMessage', () => {
        ...
        it('should handle verification errors', async () => {
            ...
            await expect(
                wallet.verifyMessage(verifyParam)
            ).rejects.toBeTruthy();
        });
    });
    ...
    describe('validAddress', () => {
        ...
        it('should invalidate testnet address (ST prefix)', async () => {
            const param: ValidAddressParams = {
                address: 'ST2XYBM8MD5T50WAMQ86E8HKR85BAEKBECNE1HHVY',
            };
        ...
        it('should invalidate testnet address (SN prefix)', async () => {
            const param: ValidAddressParams = {
                address: 'SN2XYBM8MD5T50WAMQ86E8HKR85BAEKBECNE1HHVY',
            };
    ...
    describe('Address Validation in Transaction Signing', () => {
        ...
        describe('transfer validation', () => {
            it('should reject empty toAddress in transfer transactions', async () => {
                const transferData: StxTransfer = {
                    to: '',
                    amount: 1000000,
                    memo: 'test transfer',
            ...
            it('should reject whitespace-only toAddress in transfer transactions', async () => {
                const transferData: StxTransfer = {
                    to: '   \t\n   ',
                    amount: 1000000,
                    memo: 'test transfer',
            ...
            it('should reject invalid toAddress in transfer transactions', async () => {
                const transferData: StxTransfer = {
                    to: 'invalid_address',
                    amount: 1000000,
                    memo: 'test transfer',
            ...
            it('should accept valid toAddress in transfer transactions', async () => {
                const transferData: StxTransfer = {
                    to: 'SP2XYBM8MD5T50WAMQ86E8HKR85BAEKBECNE1HHVY',
                    amount: 1000000,
                    memo: 'test transfer',
                    nonce: 1,
                    fee: 1000,
        ...
        describe('tokenTransfer validation', () => {
            it('should reject empty toAddress in token transfer transactions', async () => {
                const tokenTransferData: TokenTransfer = {
                    from: 'SP2XYBM8MD5T50WAMQ86E8HKR85BAEKBECNE1HHVY',
                    to: '',
                    amount: 1000000,
                    memo: 'test token transfer',
                    contract: 'SP2XYBM8MD5T50WAMQ86E8HKR85BAEKBECNE1HHVY',
